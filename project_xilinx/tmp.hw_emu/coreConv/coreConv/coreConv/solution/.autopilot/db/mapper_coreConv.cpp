...
extern "C" void coreConv(int, int, int, char, char, char, __cosim_s8__*, __cosim_s10__*, __cosim_s10__*, __cosim_s8__*);
extern "C" void apatb_coreConv_hw(int __xlx_apatb_param_output_num, int __xlx_apatb_param_conv_loop_cnt, int __xlx_apatb_param_contol, char __xlx_apatb_param_frac_w, char __xlx_apatb_param_frac_din, char __xlx_apatb_param_frac_dout, volatile void * __xlx_apatb_param_bias_in, volatile void * __xlx_apatb_param_weight_in, volatile void * __xlx_apatb_param_data_in, volatile void * __xlx_apatb_param_conv_out) {
  ...
  vector<__cosim_s10__> __xlx_weight_in_tmp_vec;
  while (!((hls::stream<__cosim_s10__>*)__xlx_apatb_param_weight_in)->empty() && __xlx_weight_in_V_tmp_Count < __xlx_weight_in_V_read_Size) {
    __xlx_weight_in_tmp_vec.push_back(((hls::stream<__cosim_s10__>*)__xlx_apatb_param_weight_in)->read());
    __xlx_weight_in_V_tmp_Count++;
  }
  ap_apatb_weight_in_V_cap_bc = __xlx_weight_in_tmp_vec.size();
  // store input buffer
  __cosim_s10__* __xlx_weight_in_input_buffer= new __cosim_s10__[__xlx_weight_in_tmp_vec.size()];
  ...
  vector<__cosim_s10__> __xlx_data_in_tmp_vec;
  while (!((hls::stream<__cosim_s10__>*)__xlx_apatb_param_data_in)->empty() && __xlx_data_in_V_tmp_Count < __xlx_data_in_V_read_Size) {
    __xlx_data_in_tmp_vec.push_back(((hls::stream<__cosim_s10__>*)__xlx_apatb_param_data_in)->read());
    __xlx_data_in_V_tmp_Count++;
  }
  ap_apatb_data_in_V_cap_bc = __xlx_data_in_tmp_vec.size();
  // store input buffer
  __cosim_s10__* __xlx_data_in_input_buffer= new __cosim_s10__[__xlx_data_in_tmp_vec.size()];
  ...
  // DUT call
  coreConv(__xlx_apatb_param_output_num, __xlx_apatb_param_conv_loop_cnt, __xlx_apatb_param_contol, __xlx_apatb_param_frac_w, __xlx_apatb_param_frac_din, __xlx_apatb_param_frac_dout, __xlx_bias_in_input_buffer, __xlx_weight_in_input_buffer, __xlx_data_in_input_buffer, __xlx_conv_out_input_buffer);
