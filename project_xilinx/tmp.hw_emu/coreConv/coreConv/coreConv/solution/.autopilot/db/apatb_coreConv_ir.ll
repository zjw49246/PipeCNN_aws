; ModuleID = '/home/zhoujw/FPGA/PipeCNN/project_xilinx/tmp.hw_emu/coreConv/coreConv/coreConv/solution/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_coreConv_ir(i32 %output_num, i32 %conv_loop_cnt, i32 %contol, i8 %frac_w, i8 %frac_din, i8 %frac_dout, %"class.hls::stream"* %bias_in, %"class.hls::stream.6"* %weight_in, %"class.hls::stream.6"* %data_in, %"class.hls::stream"* %conv_out) local_unnamed_addr #0 {
entry:
  %bias_in_copy = alloca %"class.hls::stream", align 512
  %weight_in_copy = alloca %"class.hls::stream.6", align 512
  %data_in_copy = alloca %"class.hls::stream.6", align 512
  %conv_out_copy = alloca %"class.hls::stream", align 512
  call fastcc void @copy_in(%"class.hls::stream"* %bias_in, %"class.hls::stream"* nonnull align 512 %bias_in_copy, %"class.hls::stream.6"* %weight_in, %"class.hls::stream.6"* nonnull align 512 %weight_in_copy, %"class.hls::stream.6"* %data_in, %"class.hls::stream.6"* nonnull align 512 %data_in_copy, %"class.hls::stream"* %conv_out, %"class.hls::stream"* nonnull align 512 %conv_out_copy)
  call void @apatb_coreConv_hw(i32 %output_num, i32 %conv_loop_cnt, i32 %contol, i8 %frac_w, i8 %frac_din, i8 %frac_dout, %"class.hls::stream"* %bias_in_copy, %"class.hls::stream.6"* %weight_in_copy, %"class.hls::stream.6"* %data_in_copy, %"class.hls::stream"* %conv_out_copy)
  call fastcc void @copy_out(%"class.hls::stream"* %bias_in, %"class.hls::stream"* nonnull align 512 %bias_in_copy, %"class.hls::stream.6"* %weight_in, %"class.hls::stream.6"* nonnull align 512 %weight_in_copy, %"class.hls::stream.6"* %data_in, %"class.hls::stream.6"* nonnull align 512 %data_in_copy, %"class.hls::stream"* %conv_out, %"class.hls::stream"* nonnull align 512 %conv_out_copy)
  ret void
}

; Function Attrs: noinline
define internal fastcc void @copy_in(%"class.hls::stream"*, %"class.hls::stream"* noalias align 512, %"class.hls::stream.6"*, %"class.hls::stream.6"* noalias align 512, %"class.hls::stream.6"*, %"class.hls::stream.6"* noalias align 512, %"class.hls::stream"*, %"class.hls::stream"* noalias align 512) unnamed_addr #1 {
entry:
...
; Function Attrs: noinline
define internal fastcc void @copy_out(%"class.hls::stream"*, %"class.hls::stream"* noalias align 512, %"class.hls::stream.6"*, %"class.hls::stream.6"* noalias align 512, %"class.hls::stream.6"*, %"class.hls::stream.6"* noalias align 512, %"class.hls::stream"*, %"class.hls::stream"* noalias align 512) unnamed_addr #5 {
entry:
...
declare void @apatb_coreConv_hw(i32, i32, i32, i8, i8, i8, %"class.hls::stream"*, %"class.hls::stream.6"*, %"class.hls::stream.6"*, %"class.hls::stream"*)

define void @coreConv_hw_stub_wrapper(i32, i32, i32, i8, i8, i8, %"class.hls::stream"*, %"class.hls::stream.6"*, %"class.hls::stream.6"*, %"class.hls::stream"*) #6 {
entry:
  call void @copy_out(%"class.hls::stream"* null, %"class.hls::stream"* %6, %"class.hls::stream.6"* null, %"class.hls::stream.6"* %7, %"class.hls::stream.6"* null, %"class.hls::stream.6"* %8, %"class.hls::stream"* null, %"class.hls::stream"* %9)
  call void @coreConv_hw_stub(i32 %0, i32 %1, i32 %2, i8 %3, i8 %4, i8 %5, %"class.hls::stream"* %6, %"class.hls::stream.6"* %7, %"class.hls::stream.6"* %8, %"class.hls::stream"* %9)
  call void @copy_in(%"class.hls::stream"* null, %"class.hls::stream"* %6, %"class.hls::stream.6"* null, %"class.hls::stream.6"* %7, %"class.hls::stream.6"* null, %"class.hls::stream.6"* %8, %"class.hls::stream"* null, %"class.hls::stream"* %9)
  ret void
}

declare void @coreConv_hw_stub(i32, i32, i32, i8, i8, i8, %"class.hls::stream"*, %"class.hls::stream.6"*, %"class.hls::stream.6"*, %"class.hls::stream"*)
