...
set IPName      "coreConv"
set Version     "1.0"
set DisplayName "Coreconv"
set Revision    "2112142103"
...
set xo_kernel_name "coreConv"
set xo_kernel_files {}
set enable_xo_gen true
set kernel_xml [file join [pwd] ../kernel/kernel.xml]
set solution_dir "/home/zhoujw/FPGA/PipeCNN/project_xilinx/tmp.hw_emu/coreConv/coreConv/coreConv/solution"
set debug_dir "/home/zhoujw/FPGA/PipeCNN/project_xilinx/tmp.hw_emu/coreConv/coreConv/coreConv/solution/.debug"
set xo_hls_files_dir ""
set hdl_module_list {coreConv_mul_32s_32s_32_2_1
...
set Interfaces {
    s_axi_control {
        ...
        registers {{0x00 CTRL       RW   0x0 "Control signals" {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 1 AP_CONTINUE R 0 "Control signal Register for 'ap_continue'." } { 5 2 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 24 RESERVED_2 R 0 "Reserved.  0s on read." }}} {0x04 GIER       RW   0x0 "Global Interrupt Enable Register" {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }} } {0x08 IP_IER     RW   0x0 "IP Interrupt Enable Register" {{ 0 1 CHAN0_INT_EN RW 0 "Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled." } { 1 1 CHAN1_INT_EN RW 0 "Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled." } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x0c IP_ISR     RW   0x0 "IP Interrupt Status Register" {{ 0 1 CHAN0_INT_ST RTOW 0 "Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 input interrupt, 1 = Channel 0 input interrup" } { 1 1 CHAN1_INT_ST RTOW 0 "Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 input interrupt, 1 = Channel 1 input interrup" } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x10 output_num W 0x0 "Data signal of output_num" {{0 32 output_num W 0 "Bit 31 to 0 of output_num"}}} {0x18 conv_loop_cnt W 0x0 "Data signal of conv_loop_cnt" {{0 32 conv_loop_cnt W 0 "Bit 31 to 0 of conv_loop_cnt"}}} {0x20 contol W 0x0 "Data signal of contol" {{0 32 contol W 0 "Bit 31 to 0 of contol"}}} {0x28 frac_w W 0x0 "Data signal of frac_w" {{0 8 frac_w W 0 "Bit 7 to 0 of frac_w"} {8 24 RESERVED R 0 "Reserved.  0s on read."}}} {0x30 frac_din W 0x0 "Data signal of frac_din" {{0 8 frac_din W 0 "Bit 7 to 0 of frac_din"} {8 24 RESERVED R 0 "Reserved.  0s on read."}}} {0x38 frac_dout W 0x0 "Data signal of frac_dout" {{0 8 frac_dout W 0 "Bit 7 to 0 of frac_dout"} {8 24 RESERVED R 0 "Reserved.  0s on read."}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
    ...
    ap_clk {
        ...
        buses "s_axi_control bias_in weight_in data_in conv_out"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
