...
set IPName      "memRead"
set Version     "1.0"
set DisplayName "Memread"
set Revision    "2112142102"
...
set xo_kernel_name "memRead"
set xo_kernel_files {}
set enable_xo_gen true
set kernel_xml [file join [pwd] ../kernel/kernel.xml]
set solution_dir "/home/zhoujw/FPGA/PipeCNN/project_xilinx/tmp.hw_emu/memRead/memRead/memRead/solution"
set debug_dir "/home/zhoujw/FPGA/PipeCNN/project_xilinx/tmp.hw_emu/memRead/memRead/memRead/solution/.debug"
set xo_hls_files_dir ""
set hdl_module_list {memRead_mul_8ns_8ns_16_1_1
...
set Interfaces {
    s_axi_control {
        ...
        registers {{0x00 CTRL       RW   0x0 "Control signals" {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 1 AP_CONTINUE R 0 "Control signal Register for 'ap_continue'." } { 5 2 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 24 RESERVED_2 R 0 "Reserved.  0s on read." }}} {0x04 GIER       RW   0x0 "Global Interrupt Enable Register" {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }} } {0x08 IP_IER     RW   0x0 "IP Interrupt Enable Register" {{ 0 1 CHAN0_INT_EN RW 0 "Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled." } { 1 1 CHAN1_INT_EN RW 0 "Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled." } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x0c IP_ISR     RW   0x0 "IP Interrupt Status Register" {{ 0 1 CHAN0_INT_ST RTOW 0 "Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 input interrupt, 1 = Channel 0 input interrup" } { 1 1 CHAN1_INT_ST RTOW 0 "Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 input interrupt, 1 = Channel 1 input interrup" } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x10 data_dim1 W 0x0 "Data signal of data_dim1" {{0 8 data_dim1 W 0 "Bit 7 to 0 of data_dim1"} {8 24 RESERVED R 0 "Reserved.  0s on read."}}} {0x18 data_dim2 W 0x0 "Data signal of data_dim2" {{0 8 data_dim2 W 0 "Bit 7 to 0 of data_dim2"} {8 24 RESERVED R 0 "Reserved.  0s on read."}}} {0x20 data_dim1xdim2 W 0x0 "Data signal of data_dim1xdim2" {{0 16 data_dim1xdim2 W 0 "Bit 15 to 0 of data_dim1xdim2"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x28 weight_dim1 W 0x0 "Data signal of weight_dim1" {{0 8 weight_dim1 W 0 "Bit 7 to 0 of weight_dim1"} {8 24 RESERVED R 0 "Reserved.  0s on read."}}} {0x30 weight_dim2 W 0x0 "Data signal of weight_dim2" {{0 8 weight_dim2 W 0 "Bit 7 to 0 of weight_dim2"} {8 24 RESERVED R 0 "Reserved.  0s on read."}}} {0x38 weight_dim3 W 0x0 "Data signal of weight_dim3" {{0 16 weight_dim3 W 0 "Bit 15 to 0 of weight_dim3"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x40 weight_dim4_div_lane W 0x0 "Data signal of weight_dim4_div_lane" {{0 16 weight_dim4_div_lane W 0 "Bit 15 to 0 of weight_dim4_div_lane"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x48 weight_dim1x2 W 0x0 "Data signal of weight_dim1x2" {{0 8 weight_dim1x2 W 0 "Bit 7 to 0 of weight_dim1x2"} {8 24 RESERVED R 0 "Reserved.  0s on read."}}} {0x50 weight_dim1x2x3 W 0x0 "Data signal of weight_dim1x2x3" {{0 32 weight_dim1x2x3 W 0 "Bit 31 to 0 of weight_dim1x2x3"}}} {0x58 conv_x W 0x0 "Data signal of conv_x" {{0 8 conv_x W 0 "Bit 7 to 0 of conv_x"} {8 24 RESERVED R 0 "Reserved.  0s on read."}}} {0x60 stride W 0x0 "Data signal of stride" {{0 8 stride W 0 "Bit 7 to 0 of stride"} {8 24 RESERVED R 0 "Reserved.  0s on read."}}} {0x68 padding W 0x0 "Data signal of padding" {{0 8 padding W 0 "Bit 7 to 0 of padding"} {8 24 RESERVED R 0 "Reserved.  0s on read."}}} {0x70 split W 0x0 "Data signal of split" {{0 8 split W 0 "Bit 7 to 0 of split"} {8 24 RESERVED R 0 "Reserved.  0s on read."}}} {0x78 group_num_x W 0x0 "Data signal of group_num_x" {{0 8 group_num_x W 0 "Bit 7 to 0 of group_num_x"} {8 24 RESERVED R 0 "Reserved.  0s on read."}}} {0x80 group_num_y W 0x0 "Data signal of group_num_y" {{0 8 group_num_y W 0 "Bit 7 to 0 of group_num_y"} {8 24 RESERVED R 0 "Reserved.  0s on read."}}} {0x88 group_rem_size_x W 0x0 "Data signal of group_rem_size_x" {{0 8 group_rem_size_x W 0 "Bit 7 to 0 of group_rem_size_x"} {8 24 RESERVED R 0 "Reserved.  0s on read."}}} {0x90 group_rem_size_xyz W 0x0 "Data signal of group_rem_size_xyz" {{0 32 group_rem_size_xyz W 0 "Bit 31 to 0 of group_rem_size_xyz"}}} {0x98 win_size_x W 0x0 "Data signal of win_size_x" {{0 8 win_size_x W 0 "Bit 7 to 0 of win_size_x"} {8 24 RESERVED R 0 "Reserved.  0s on read."}}} {0xa0 win_size_y W 0x0 "Data signal of win_size_y" {{0 8 win_size_y W 0 "Bit 7 to 0 of win_size_y"} {8 24 RESERVED R 0 "Reserved.  0s on read."}}} {0xa8 win_size_xyz W 0x0 "Data signal of win_size_xyz" {{0 32 win_size_xyz W 0 "Bit 31 to 0 of win_size_xyz"}}} {0xb0 bottom_1 W 0x0 "Data signal of bottom" {{0 32 bottom W 0 "Bit 31 to 0 of bottom"}}} {0xb4 bottom_2 W 0x0 "Data signal of bottom" {{0 32 bottom W 0 "Bit 63 to 32 of bottom"}}} {0xbc weights_1 W 0x0 "Data signal of weights" {{0 32 weights W 0 "Bit 31 to 0 of weights"}}} {0xc0 weights_2 W 0x0 "Data signal of weights" {{0 32 weights W 0 "Bit 63 to 32 of weights"}}} {0xc8 bias_1 W 0x0 "Data signal of bias" {{0 32 bias W 0 "Bit 31 to 0 of bias"}}} {0xcc bias_2 W 0x0 "Data signal of bias" {{0 32 bias W 0 "Bit 63 to 32 of bias"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
    ...
    ap_clk {
        ...
        buses "s_axi_control m_axi_gmem0 m_axi_gmem1 m_axi_gmem2 bias_out weight_out data_out"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
...
source -notrace "/mnt/storage/gefeizuo/Xilinx/Vitis_HLS/2020.2/common/scripts/ipxhls.tcl"
