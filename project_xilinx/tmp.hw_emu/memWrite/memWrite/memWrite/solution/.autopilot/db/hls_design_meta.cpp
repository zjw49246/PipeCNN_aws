...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("conv_in_TDATA", 16, hls_in, 13, "axis", "in_data", 1),
	Port_Property("conv_in_TVALID", 1, hls_in, 16, "axis", "in_vld", 1),
	Port_Property("conv_in_TREADY", 1, hls_out, 16, "axis", "in_acc", 1),
	Port_Property("conv_in_TKEEP", 2, hls_in, 14, "axis", "in_data", 1),
	Port_Property("conv_in_TSTRB", 2, hls_in, 15, "axis", "in_data", 1),
	Port_Property("conv_in_TLAST", 1, hls_in, 16, "axis", "in_data", 1),
...
const char* HLS_Design_Meta::dut_name = "memWrite";
