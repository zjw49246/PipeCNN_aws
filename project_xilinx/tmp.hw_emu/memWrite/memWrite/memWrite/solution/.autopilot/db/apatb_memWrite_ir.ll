; ModuleID = '/home/zhoujw/FPGA/PipeCNN/project_xilinx/tmp.hw_emu/memWrite/memWrite/memWrite/solution/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_memWrite_ir(i8 %out_dim1, i8 %out_dim2, i16 %out_dim3, i16 %out_dim1xbatch, i32 %out_dim1x2xbatch, i8 %batch_indx_dim1, i8 %batch_indx_dim2, i8 %padd_offset, i8 %pool_on, i8 %pool_size, i8 %pool_stride, i8* %top, %"class.hls::stream"* %conv_in) local_unnamed_addr #0 {
entry:
  %top_copy = alloca i8, align 512
  %conv_in_copy = alloca %"class.hls::stream", align 512
  call fastcc void @copy_in(i8* %top, i8* nonnull align 512 %top_copy, %"class.hls::stream"* %conv_in, %"class.hls::stream"* nonnull align 512 %conv_in_copy)
  call void @apatb_memWrite_hw(i8 %out_dim1, i8 %out_dim2, i16 %out_dim3, i16 %out_dim1xbatch, i32 %out_dim1x2xbatch, i8 %batch_indx_dim1, i8 %batch_indx_dim2, i8 %padd_offset, i8 %pool_on, i8 %pool_size, i8 %pool_stride, i8* %top_copy, %"class.hls::stream"* %conv_in_copy)
  call fastcc void @copy_out(i8* %top, i8* nonnull align 512 %top_copy, %"class.hls::stream"* %conv_in, %"class.hls::stream"* nonnull align 512 %conv_in_copy)
  ret void
}

; Function Attrs: noinline
define internal fastcc void @copy_in(i8* readonly, i8* noalias align 512, %"class.hls::stream"*, %"class.hls::stream"* noalias align 512) unnamed_addr #1 {
entry:
...
; Function Attrs: noinline
define internal fastcc void @copy_out(i8*, i8* noalias readonly align 512, %"class.hls::stream"*, %"class.hls::stream"* noalias align 512) unnamed_addr #6 {
entry:
...
declare void @apatb_memWrite_hw(i8, i8, i16, i16, i32, i8, i8, i8, i8, i8, i8, i8*, %"class.hls::stream"*)

define void @memWrite_hw_stub_wrapper(i8, i8, i16, i16, i32, i8, i8, i8, i8, i8, i8, i8*, %"class.hls::stream"*) #7 {
entry:
  call void @copy_out(i8* null, i8* %11, %"class.hls::stream"* null, %"class.hls::stream"* %12)
  call void @memWrite_hw_stub(i8 %0, i8 %1, i16 %2, i16 %3, i32 %4, i8 %5, i8 %6, i8 %7, i8 %8, i8 %9, i8 %10, i8* %11, %"class.hls::stream"* %12)
  call void @copy_in(i8* null, i8* %11, %"class.hls::stream"* null, %"class.hls::stream"* %12)
  ret void
}

declare void @memWrite_hw_stub(i8, i8, i16, i16, i32, i8, i8, i8, i8, i8, i8, i8*, %"class.hls::stream"*)
