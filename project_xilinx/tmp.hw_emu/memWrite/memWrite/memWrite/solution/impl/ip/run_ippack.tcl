...
set IPName      "memWrite"
set Version     "1.0"
set DisplayName "Memwrite"
set Revision    "2112142104"
...
set xo_kernel_name "memWrite"
set xo_kernel_files {}
set enable_xo_gen true
set kernel_xml [file join [pwd] ../kernel/kernel.xml]
set solution_dir "/home/zhoujw/FPGA/PipeCNN/project_xilinx/tmp.hw_emu/memWrite/memWrite/memWrite/solution"
set debug_dir "/home/zhoujw/FPGA/PipeCNN/project_xilinx/tmp.hw_emu/memWrite/memWrite/memWrite/solution/.debug"
set xo_hls_files_dir ""
set hdl_module_list {memWrite_mul_8ns_8ns_16_1_1
...
set Interfaces {
    s_axi_control {
        ...
        registers {{0x00 CTRL       RW   0x0 "Control signals" {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 1 AP_CONTINUE R 0 "Control signal Register for 'ap_continue'." } { 5 2 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 24 RESERVED_2 R 0 "Reserved.  0s on read." }}} {0x04 GIER       RW   0x0 "Global Interrupt Enable Register" {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }} } {0x08 IP_IER     RW   0x0 "IP Interrupt Enable Register" {{ 0 1 CHAN0_INT_EN RW 0 "Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled." } { 1 1 CHAN1_INT_EN RW 0 "Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled." } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x0c IP_ISR     RW   0x0 "IP Interrupt Status Register" {{ 0 1 CHAN0_INT_ST RTOW 0 "Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 input interrupt, 1 = Channel 0 input interrup" } { 1 1 CHAN1_INT_ST RTOW 0 "Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 input interrupt, 1 = Channel 1 input interrup" } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x10 out_dim1 W 0x0 "Data signal of out_dim1" {{0 8 out_dim1 W 0 "Bit 7 to 0 of out_dim1"} {8 24 RESERVED R 0 "Reserved.  0s on read."}}} {0x18 out_dim2 W 0x0 "Data signal of out_dim2" {{0 8 out_dim2 W 0 "Bit 7 to 0 of out_dim2"} {8 24 RESERVED R 0 "Reserved.  0s on read."}}} {0x20 out_dim3 W 0x0 "Data signal of out_dim3" {{0 16 out_dim3 W 0 "Bit 15 to 0 of out_dim3"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x28 out_dim1xbatch W 0x0 "Data signal of out_dim1xbatch" {{0 16 out_dim1xbatch W 0 "Bit 15 to 0 of out_dim1xbatch"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x30 out_dim1x2xbatch W 0x0 "Data signal of out_dim1x2xbatch" {{0 32 out_dim1x2xbatch W 0 "Bit 31 to 0 of out_dim1x2xbatch"}}} {0x38 batch_indx_dim1 W 0x0 "Data signal of batch_indx_dim1" {{0 8 batch_indx_dim1 W 0 "Bit 7 to 0 of batch_indx_dim1"} {8 24 RESERVED R 0 "Reserved.  0s on read."}}} {0x40 batch_indx_dim2 W 0x0 "Data signal of batch_indx_dim2" {{0 8 batch_indx_dim2 W 0 "Bit 7 to 0 of batch_indx_dim2"} {8 24 RESERVED R 0 "Reserved.  0s on read."}}} {0x48 padd_offset W 0x0 "Data signal of padd_offset" {{0 8 padd_offset W 0 "Bit 7 to 0 of padd_offset"} {8 24 RESERVED R 0 "Reserved.  0s on read."}}} {0x50 pool_on W 0x0 "Data signal of pool_on" {{0 8 pool_on W 0 "Bit 7 to 0 of pool_on"} {8 24 RESERVED R 0 "Reserved.  0s on read."}}} {0x58 pool_size W 0x0 "Data signal of pool_size" {{0 8 pool_size W 0 "Bit 7 to 0 of pool_size"} {8 24 RESERVED R 0 "Reserved.  0s on read."}}} {0x60 pool_stride W 0x0 "Data signal of pool_stride" {{0 8 pool_stride W 0 "Bit 7 to 0 of pool_stride"} {8 24 RESERVED R 0 "Reserved.  0s on read."}}} {0x68 top_1 W 0x0 "Data signal of top" {{0 32 top W 0 "Bit 31 to 0 of top"}}} {0x6c top_2 W 0x0 "Data signal of top" {{0 32 top W 0 "Bit 63 to 32 of top"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
    ...
    ap_clk {
        ...
        buses "s_axi_control m_axi_gmem0 conv_in"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
