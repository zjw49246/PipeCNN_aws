...
set xo_kernel_name "maxPool"
set xo_kernel_files {}
set enable_xo_gen true
set kernel_xml [file join [pwd] ../kernel/kernel.xml]
set solution_dir "/home/zhoujw/FPGA/PipeCNN/project_xilinx/tmp.hw_emu/maxPool/maxPool/maxPool/solution"
set debug_dir "/home/zhoujw/FPGA/PipeCNN/project_xilinx/tmp.hw_emu/maxPool/maxPool/maxPool/solution/.debug"
set xo_hls_files_dir ""
set hdl_module_list {maxPool_mul_8ns_8ns_16_1_1
...
set Interfaces {
    s_axi_control {
        ...
        registers {{0x00 CTRL       RW   0x0 "Control signals" {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 1 AP_CONTINUE R 0 "Control signal Register for 'ap_continue'." } { 5 2 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 24 RESERVED_2 R 0 "Reserved.  0s on read." }}} {0x04 GIER       RW   0x0 "Global Interrupt Enable Register" {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }} } {0x08 IP_IER     RW   0x0 "IP Interrupt Enable Register" {{ 0 1 CHAN0_INT_EN RW 0 "Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled." } { 1 1 CHAN1_INT_EN RW 0 "Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled." } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x0c IP_ISR     RW   0x0 "IP Interrupt Status Register" {{ 0 1 CHAN0_INT_ST RTOW 0 "Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 input interrupt, 1 = Channel 0 input interrup" } { 1 1 CHAN1_INT_ST RTOW 0 "Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 input interrupt, 1 = Channel 1 input interrup" } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x10 conv_x W 0x0 "Data signal of conv_x" {{0 8 conv_x W 0 "Bit 7 to 0 of conv_x"} {8 24 RESERVED R 0 "Reserved.  0s on read."}}} {0x18 conv_xy W 0x0 "Data signal of conv_xy" {{0 16 conv_xy W 0 "Bit 15 to 0 of conv_xy"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x20 pool_dim1 W 0x0 "Data signal of pool_dim1" {{0 8 pool_dim1 W 0 "Bit 7 to 0 of pool_dim1"} {8 24 RESERVED R 0 "Reserved.  0s on read."}}} {0x28 pool_dim3 W 0x0 "Data signal of pool_dim3" {{0 16 pool_dim3 W 0 "Bit 15 to 0 of pool_dim3"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x30 pool_dim1x2 W 0x0 "Data signal of pool_dim1x2" {{0 16 pool_dim1x2 W 0 "Bit 15 to 0 of pool_dim1x2"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x38 pool_size W 0x0 "Data signal of pool_size" {{0 8 pool_size W 0 "Bit 7 to 0 of pool_size"} {8 24 RESERVED R 0 "Reserved.  0s on read."}}} {0x40 pool_stride W 0x0 "Data signal of pool_stride" {{0 8 pool_stride W 0 "Bit 7 to 0 of pool_stride"} {8 24 RESERVED R 0 "Reserved.  0s on read."}}} {0x48 padd_offset W 0x0 "Data signal of padd_offset" {{0 8 padd_offset W 0 "Bit 7 to 0 of padd_offset"} {8 24 RESERVED R 0 "Reserved.  0s on read."}}} {0x50 pool_times W 0x0 "Data signal of pool_times" {{0 16 pool_times W 0 "Bit 15 to 0 of pool_times"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x58 pool_group W 0x0 "Data signal of pool_group" {{0 16 pool_group W 0 "Bit 15 to 0 of pool_group"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x60 pool_y_bound W 0x0 "Data signal of pool_y_bound" {{0 16 pool_y_bound W 0 "Bit 15 to 0 of pool_y_bound"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x68 item_loop_bound W 0x0 "Data signal of item_loop_bound" {{0 16 item_loop_bound W 0 "Bit 15 to 0 of item_loop_bound"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x70 load_data_bound W 0x0 "Data signal of load_data_bound" {{0 16 load_data_bound W 0 "Bit 15 to 0 of load_data_bound"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x78 write_back_bound W 0x0 "Data signal of write_back_bound" {{0 16 write_back_bound W 0 "Bit 15 to 0 of write_back_bound"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x80 pool_win_num_x W 0x0 "Data signal of pool_win_num_x" {{0 8 pool_win_num_x W 0 "Bit 7 to 0 of pool_win_num_x"} {8 24 RESERVED R 0 "Reserved.  0s on read."}}} {0x88 win_size_x W 0x0 "Data signal of win_size_x" {{0 8 win_size_x W 0 "Bit 7 to 0 of win_size_x"} {8 24 RESERVED R 0 "Reserved.  0s on read."}}} {0x90 bottom_1 W 0x0 "Data signal of bottom" {{0 32 bottom W 0 "Bit 31 to 0 of bottom"}}} {0x94 bottom_2 W 0x0 "Data signal of bottom" {{0 32 bottom W 0 "Bit 63 to 32 of bottom"}}} {0x9c top_1 W 0x0 "Data signal of top" {{0 32 top W 0 "Bit 31 to 0 of top"}}} {0xa0 top_2 W 0x0 "Data signal of top" {{0 32 top W 0 "Bit 63 to 32 of top"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
