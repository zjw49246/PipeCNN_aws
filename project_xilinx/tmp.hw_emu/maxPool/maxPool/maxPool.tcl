...
set_top maxPool
# v++ -g, -D, -I, --advanced.prop kernel.maxPool.kernel_flags
add_files "/home/zhoujw/FPGA/PipeCNN/project_xilinx/device/maxPool.cpp" -cflags " -g -D VGG16 -I /home/zhoujw/FPGA/PipeCNN/project_xilinx/device "
...
config_export -format ip_catalog -ipname maxPool
csynth_design
export_design
close_project
