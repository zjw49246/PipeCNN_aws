...
// ==============================================================
`timescale 1 ns / 1 ps
module memRead_win_buffer_0_data_ram (addr0, ce0, d0, we0, addr1, ce1, q1,  clk);
...
`timescale 1 ns / 1 ps
module memRead_win_buffer_0_data(
    reset,
    clk,
    address0,
    ce0,
...
memRead_win_buffer_0_data_ram memRead_win_buffer_0_data_ram_U(
    .clk( clk ),
    .addr0( address0 ),
    .ce0( ce0 ),
    .we0( we0 ),
